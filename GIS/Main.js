    ...
    function (
        ...
        return declare(null, {
            ...
            startup: function (config) {
                ...
                this.QueryDriver = new QueryDriver();
            ...
            SimilarQuery: function(q){
                this.ExactQuery('%'+q+'%')
                
            },
            ExactQuery: function(q){
                this.QueryDriver.query(q)
            },
            _addMapWidgets: function () {
                ...
                if (this.config.home) {
                    require(["esri/dijit/HomeButton"], lang.hitch(this, function (HomeButton) {
                        ...
                        var home = new HomeButton({
                            map: this.map
                        }, domConstruct.create("div", {}, dquery(".esriSimpleSliderIncrementButton")[0], "after"));
                        home.startup();
                ...
                if (this.config.search) {
                    ...
                    require(["esri/dijit/Search", "esri/tasks/locator", "esri/InfoTemplate", "esri/lang"], lang.hitch(this, function (Search, Locator, InfoTemplate, esriLang) {
                        if (!Search && !Locator) {
                            return;
                        }
            ...
            _createWebMap: function (itemInfo) {
                ...
                itemInfo.item.spatialReference = { "wkid":102100 }
                itemInfo.itemData.spatialReference = { "latestWkid":102100, "wkid":102100 }
                ...
                arcgisUtils.createMap(itemInfo, "mapDiv", {
                    ...
                    extent: new esri.geometry.Extent(242102,5589768,299188,5844405,new esri.SpatialReference({wkid:28355}))
                    ...
                    domClass.remove(document.body, "app-loading");
                    this._addMapWidgets();
                    this.QueryDriver.startup(this.config, this.map);
            ...
            _updateTheme: function () {
                ...
                dquery(".bg").style("backgroundColor", this.config.theme.toString());
                dquery(".esriPopup .pointer").style("backgroundColor", this.config.theme.toString());
                dquery(".esriPopup .titlePane").style("backgroundColor", this.config.theme.toString());


                //Set the font color using the configured color value
                dquery(".fc").style("color", this.config.color.toString());
                dquery(".esriPopup .titlePane").style("color", this.config.color.toString());
                dquery(".esriPopup. .titleButton").style("color", this.config.color.toString());
                ...
                if (this.config.icons === "black") {
                    dquery(".esriSimpleSlider").style("color", "#000");
                    dquery(".icon-color").style("color", "#000");
                }
            },
