define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/_base/json", "dojo/dom-construct", "esri/lang", "esri/tasks/locator", "esri/layers/FeatureLayer","esri/InfoTemplate", "esri/dijit/Search"], function(
  declare, lang, array, dojoJson, domConstruct, esriLang, Locator, FeatureLayer,InfoTemplate, Search) {
  return declare(null, {
    ...
    _createAppConfigSources: function() {
      ...
      array.forEach(configSource, lang.hitch(this, function(source) {
        if (source.locator) {
         ...
         //featureLayer.name = source.name;
         source.infoTemplate = new InfoTemplate("Search Result", source.infoTemplateStr);
